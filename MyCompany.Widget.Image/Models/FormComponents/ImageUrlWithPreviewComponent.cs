...
namespace MyCompany.Widget.Image.Models
{
    public class ImageUrlWithPreviewComponent : FormComponent<ImageUrlWithPreviewProperties, string>
    {
        ...
        /// </summary>
        public const string IDENTIFIER = "Company.FormComponent.ImageUrlWithPreview";
